...
-- AlterTable
ALTER TABLE `StockGroup` ADD COLUMN `isDirectShipping` BOOLEAN NOT NULL DEFAULT false;
...
CREATE TABLE `ByOffsetPair` (
    ...
    UNIQUE INDEX `ByOffsetPair_byOffsetPairId_key`(`byOffsetPairId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `ByOffsetPair` ADD CONSTRAINT `ByOffsetPair_byOffsetPairId_fkey` FOREIGN KEY (`byOffsetPairId`) REFERENCES `ByOffset`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
