...
export const TAX_INVOICE = {
  ...
  issuedDate: true,
  sendedDate: true,
  dstCompanyRegistrationNumber: true,
  dstCompanyName: true,
  dstCompanyRepresentative: true,
  dstCompanyAddress: true,
  dstCompanyBizType: true,
  dstCompanyBizItem: true,
  dstEmail: true,
  srcCompanyRegistrationNumber: true,
  srcCompanyName: true,
  srcCompanyRepresentative: true,
