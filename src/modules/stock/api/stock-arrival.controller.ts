...
import {
  StockArrivalApplyDto,
  StockArrivalDetailDto,
  StockArrivalListQueryDto,
  StockArrivalPriceUpdateDto,
} from './dto/stock-arrival.request';
...
export class StockArrivalController {
  ...
  async getDetail(
    ...
    const item = await this.retrive.getDetail({
      companyId: req.user.companyId,
      ...dto,
    });
    return item;
