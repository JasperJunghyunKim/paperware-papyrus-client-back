...
} from 'src/@shared/api/inhouse/discount-rate.response';
...
import {
  DiscountRateConditionIdDto,
  DiscountRateCreateDto,
  DiscountRateDeleteDto,
  DiscountRateDetailDto,
  DiscountRateListDto,
  DiscountRateMappingDto,
  DiscountRateUpdateDto,
} from './dto/discount-rate.request';
...
export class DiscountRateController {
  ...
  @Post()
  @UseGuards(AuthGuard)
  async create(@Request() req: AuthType, @Body() dto: DiscountRateCreateDto) {
    dto.validate();
