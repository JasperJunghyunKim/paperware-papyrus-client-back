      ...
      from(
        this.prisma.security.create({
          data: {
            ...
            securityStatus: securityCreateRequest.securityStatus,
            drawedStatus: securityCreateRequest.drawedStatus,
      ...
      from(
        this.prisma.security.update({
          data: {
            ...
            drawedStatus: securityUpdateRequest.drawedStatus,
