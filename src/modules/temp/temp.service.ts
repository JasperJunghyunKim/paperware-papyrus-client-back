    ...
    async updateTradePrice(
        ...
        await this.prisma.$transaction(async tx => {
            ...
            if (tradePrice.orderStockTradePrice) {
                if (!tradePriceDto.orderStockTradePrice) throw new BadRequestException(`orderStockTradePrice가 필요합니다.`);

                await tx.orderStockTradePrice.update({
                    data: {
                        officialPriceType: tradePriceDto.orderStockTradePrice.officialPriceType,
                        officialPrice: tradePriceDto.orderStockTradePrice.officialPrice,
                        officialPriceUnit: tradePriceDto.orderStockTradePrice.officialPriceUnit,
                ...
                const altBundle = tradePriceDto.orderStockTradePrice.orderStockTradeAltBundle;
                if (altBundle) {
